...
export const ViewCategoryModal = () => {
  ...
  const { openViewCategory, setOpenViewCategory, category, setCategory } = useCategoryStore()
  ...
  return (
    <Dialog open={openViewCategory} onClose={onClose} fullWidth>
      <form autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
        <DialogTitle>
          <Typography variant='h2'>Chi tiết danh mục</Typography>
          <FormGroup
            sx={theme => ({
              position: 'absolute',
              right: 20,
